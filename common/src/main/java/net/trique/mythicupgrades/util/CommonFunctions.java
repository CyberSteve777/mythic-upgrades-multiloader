...
public class CommonFunctions {
    ...
    public static  <T extends LivingEntity>  boolean checkForItemMastery(T user) {
        return !user.hasEffect(MUEffects.ITEM_MASTERY) || (user.hasEffect(MUEffects.ITEM_MASTERY) && Constants.RANDOM.nextFloat() > 0.1f * (user.getEffect(MUEffects.ITEM_MASTERY).getAmplifier() + 1));
    }
}