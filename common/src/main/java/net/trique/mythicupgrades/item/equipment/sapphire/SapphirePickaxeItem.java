...
public class SapphirePickaxeItem extends MythicEffectsPickaxeItem {
    ...
    public SapphirePickaxeItem(Properties settings, String tooltipKey, ChatFormatting color, Supplier<EffectList> whenInHand, Supplier<EffectList> forSelfWhenHit, Supplier<EffectList> forTargetWhenHit) {
