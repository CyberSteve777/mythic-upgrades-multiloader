...
import net.trique.mythicupgrades.item.equipment.common.MythicEffectsAxeItem;
...
public class SapphireAxeItem extends MythicEffectsAxeItem {
    ...
    public SapphireAxeItem(Properties settings, String tooltipKey, ChatFormatting color, Supplier<EffectList> whenInHand, Supplier<EffectList> forSelfWhenHit, Supplier<EffectList> forTargetWhenHit) {
