...
public class MUTemplateItem extends SmithingTemplateItem {
    ...
    static {
        ...
        PERIDOT_UPGRADE_TEXT = Component.translatable(Util.makeDescriptionId("upgrade", ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, "peridot_upgrade"))).withStyle(TITLE_FORMATTING);
        PERIDOT_UPGRADE_APPLIES_TO_TEXT = Component.translatable(Util.makeDescriptionId("item", ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, "smithing_template.peridot_upgrade.applies_to"))).withStyle(DESCRIPTION_FORMATTING);
        PERIDOT_UPGRADE_INGREDIENTS_TEXT = Component.translatable(Util.makeDescriptionId("item", ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, "smithing_template.peridot_upgrade.ingredients"))).withStyle(DESCRIPTION_FORMATTING);
        PERIDOT_UPGRADE_BASE_SLOT_DESCRIPTION_TEXT = Component.translatable(Util.makeDescriptionId("item", ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, "smithing_template.peridot_upgrade.base_slot_description")));
        PERIDOT_UPGRADE_ADDITIONS_SLOT_DESCRIPTION_TEXT = Component.translatable(Util.makeDescriptionId("item", ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, "smithing_template.peridot_upgrade.additions_slot_description")));

        TOPAZ_UPGRADE_TEXT = Component.translatable(Util.makeDescriptionId("upgrade", ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, "topaz_upgrade"))).withStyle(TITLE_FORMATTING);
        TOPAZ_UPGRADE_APPLIES_TO_TEXT = Component.translatable(Util.makeDescriptionId("item", ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, "smithing_template.topaz_upgrade.applies_to"))).withStyle(DESCRIPTION_FORMATTING);
        TOPAZ_UPGRADE_INGREDIENTS_TEXT = Component.translatable(Util.makeDescriptionId("item", ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, "smithing_template.topaz_upgrade.ingredients"))).withStyle(DESCRIPTION_FORMATTING);
        TOPAZ_UPGRADE_BASE_SLOT_DESCRIPTION_TEXT = Component.translatable(Util.makeDescriptionId("item", ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, "smithing_template.topaz_upgrade.base_slot_description")));
        TOPAZ_UPGRADE_ADDITIONS_SLOT_DESCRIPTION_TEXT = Component.translatable(Util.makeDescriptionId("item", ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, "smithing_template.topaz_upgrade.additions_slot_description")));

        AQUAMARINE_UPGRADE_TEXT = Component.translatable(Util.makeDescriptionId("upgrade", ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, "aquamarine_upgrade"))).withStyle(TITLE_FORMATTING);
        AQUAMARINE_UPGRADE_APPLIES_TO_TEXT = Component.translatable(Util.makeDescriptionId("item", ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, "smithing_template.aquamarine_upgrade.applies_to"))).withStyle(DESCRIPTION_FORMATTING);
        AQUAMARINE_UPGRADE_INGREDIENTS_TEXT = Component.translatable(Util.makeDescriptionId("item", ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, "smithing_template.aquamarine_upgrade.ingredients"))).withStyle(DESCRIPTION_FORMATTING);
        AQUAMARINE_UPGRADE_BASE_SLOT_DESCRIPTION_TEXT = Component.translatable(Util.makeDescriptionId("item", ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, "smithing_template.aquamarine_upgrade.base_slot_description")));
        AQUAMARINE_UPGRADE_ADDITIONS_SLOT_DESCRIPTION_TEXT = Component.translatable(Util.makeDescriptionId("item", ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, "smithing_template.aquamarine_upgrade.additions_slot_description")));
    
        SAPPHIRE_UPGRADE_TEXT = Component.translatable(Util.makeDescriptionId("upgrade", ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, "sapphire_upgrade"))).withStyle(TITLE_FORMATTING);
        SAPPHIRE_UPGRADE_APPLIES_TO_TEXT = Component.translatable(Util.makeDescriptionId("item", ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, "smithing_template.sapphire_upgrade.applies_to"))).withStyle(DESCRIPTION_FORMATTING);
        SAPPHIRE_UPGRADE_INGREDIENTS_TEXT = Component.translatable(Util.makeDescriptionId("item", ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, "smithing_template.sapphire_upgrade.ingredients"))).withStyle(DESCRIPTION_FORMATTING);
        SAPPHIRE_UPGRADE_BASE_SLOT_DESCRIPTION_TEXT = Component.translatable(Util.makeDescriptionId("item", ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, "smithing_template.sapphire_upgrade.base_slot_description")));
        SAPPHIRE_UPGRADE_ADDITIONS_SLOT_DESCRIPTION_TEXT = Component.translatable(Util.makeDescriptionId("item", ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, "smithing_template.sapphire_upgrade.additions_slot_description")));

        RUBY_UPGRADE_TEXT = Component.translatable(Util.makeDescriptionId("upgrade", ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, "ruby_upgrade"))).withStyle(TITLE_FORMATTING);
        RUBY_UPGRADE_APPLIES_TO_TEXT = Component.translatable(Util.makeDescriptionId("item", ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, "smithing_template.ruby_upgrade.applies_to"))).withStyle(DESCRIPTION_FORMATTING);
        RUBY_UPGRADE_INGREDIENTS_TEXT = Component.translatable(Util.makeDescriptionId("item", ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, "smithing_template.ruby_upgrade.ingredients"))).withStyle(DESCRIPTION_FORMATTING);
        RUBY_UPGRADE_BASE_SLOT_DESCRIPTION_TEXT = Component.translatable(Util.makeDescriptionId("item", ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, "smithing_template.ruby_upgrade.base_slot_description")));
        RUBY_UPGRADE_ADDITIONS_SLOT_DESCRIPTION_TEXT = Component.translatable(Util.makeDescriptionId("item", ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, "smithing_template.ruby_upgrade.additions_slot_description")));

        AMETRINE_UPGRADE_TEXT = Component.translatable(Util.makeDescriptionId("upgrade", ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, "ametrine_upgrade"))).withStyle(TITLE_FORMATTING);
        AMETRINE_UPGRADE_APPLIES_TO_TEXT = Component.translatable(Util.makeDescriptionId("item", ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, "smithing_template.ametrine_upgrade.applies_to"))).withStyle(DESCRIPTION_FORMATTING);
        AMETRINE_UPGRADE_INGREDIENTS_TEXT = Component.translatable(Util.makeDescriptionId("item", ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, "smithing_template.ametrine_upgrade.ingredients"))).withStyle(DESCRIPTION_FORMATTING);
        AMETRINE_UPGRADE_BASE_SLOT_DESCRIPTION_TEXT = Component.translatable(Util.makeDescriptionId("item", ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, "smithing_template.ametrine_upgrade.base_slot_description")));
        AMETRINE_UPGRADE_ADDITIONS_SLOT_DESCRIPTION_TEXT = Component.translatable(Util.makeDescriptionId("item", ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, "smithing_template.ametrine_upgrade.additions_slot_description")));
    
        JADE_UPGRADE_TEXT = Component.translatable(Util.makeDescriptionId("upgrade", ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, "jade_upgrade"))).withStyle(TITLE_FORMATTING);
        JADE_UPGRADE_APPLIES_TO_TEXT = Component.translatable(Util.makeDescriptionId("item", ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, "smithing_template.jade_upgrade.applies_to"))).withStyle(DESCRIPTION_FORMATTING);
        JADE_UPGRADE_INGREDIENTS_TEXT = Component.translatable(Util.makeDescriptionId("item", ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, "smithing_template.jade_upgrade.ingredients"))).withStyle(DESCRIPTION_FORMATTING);
        JADE_UPGRADE_BASE_SLOT_DESCRIPTION_TEXT = Component.translatable(Util.makeDescriptionId("item", ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, "smithing_template.jade_upgrade.base_slot_description")));
        JADE_UPGRADE_ADDITIONS_SLOT_DESCRIPTION_TEXT = Component.translatable(Util.makeDescriptionId("item", ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, "smithing_template.jade_upgrade.additions_slot_description")));
    }
}