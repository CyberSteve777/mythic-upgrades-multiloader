...
import net.trique.mythicupgrades.item.equipment.common.MythicEffectsHoeItem;
...
public class SapphireHoeItem extends MythicEffectsHoeItem {
    ...
    public SapphireHoeItem(Properties settings, String tooltipKey, ChatFormatting color, Supplier<EffectList> whenInHand, Supplier<EffectList> forSelfWhenHit, Supplier<EffectList> forTargetWhenHit) {
