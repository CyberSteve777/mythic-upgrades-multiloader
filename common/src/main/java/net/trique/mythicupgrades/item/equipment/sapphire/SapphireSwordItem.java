...
public class SapphireSwordItem extends MythicEffectsSwordItem {
    ...
    public SapphireSwordItem(Properties settings, String tooltipKey, ChatFormatting color, Supplier<EffectList> whenInHand, Supplier<EffectList> forSelfWhenHit, Supplier<EffectList> forTargetWhenHit) {
