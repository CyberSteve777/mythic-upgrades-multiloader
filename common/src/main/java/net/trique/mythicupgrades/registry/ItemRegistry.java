...
import static net.trique.mythicupgrades.registry.ArmorSetRegistry.*;
...
public class ItemRegistry {
    ...
    public static final RegistryObject<Item, MythicEffectsShovelItem> JADE_SHOVEL = ITEMS.register("jade_shovel", () -> new MythicEffectsShovelItem(MUToolMaterials.JADE, getFireResistantProperties().attributes(MythicEffectsShovelItem.createAttributes(MUToolMaterials.JADE, 2, -2.9f)), "jade_tool.description", ChatFormatting.DARK_GREEN, ItemRegistry::getJadeToolEffectList, ItemRegistry::getEmptyList, ItemRegistry::getEmptyList));
    public static final RegistryObject<Item, MythicEffectsPickaxeItem> JADE_PICKAXE = ITEMS.register("jade_pickaxe", () -> new MythicEffectsPickaxeItem(MUToolMaterials.JADE, getFireResistantProperties().attributes(MythicEffectsPickaxeItem.createAttributes(MUToolMaterials.JADE, 1, -2.7f)), "jade_tool.description", ChatFormatting.DARK_GREEN, ItemRegistry::getJadeToolEffectList, ItemRegistry::getEmptyList, ItemRegistry::getEmptyList));
    public static final RegistryObject<Item, MythicEffectsHoeItem> JADE_HOE = ITEMS.register("jade_hoe", () -> new MythicEffectsHoeItem(MUToolMaterials.JADE, getFireResistantProperties().attributes(MythicEffectsHoeItem.createAttributes(MUToolMaterials.JADE, -4, 0.1f)), "jade_tool.description", ChatFormatting.DARK_GREEN, ItemRegistry::getJadeToolEffectList, ItemRegistry::getEmptyList, ItemRegistry::getEmptyList));
    public static final RegistryObject<Item, MythicEffectsAxeItem> JADE_AXE = ITEMS.register("jade_axe", () -> new MythicEffectsAxeItem(MUToolMaterials.JADE, getFireResistantProperties().attributes(MythicEffectsAxeItem.createAttributes(MUToolMaterials.JADE, 5, -2.9f)), "jade_tool.description", ChatFormatting.DARK_GREEN, ItemRegistry::getJadeToolEffectList, ItemRegistry::getEmptyList, ItemRegistry::getEmptyList));
    public static final RegistryObject<Item, MythicEffectsSwordItem> JADE_SWORD = ITEMS.register("jade_sword", () -> new MythicEffectsSwordItem(MUToolMaterials.JADE, getFireResistantProperties().attributes(MythicEffectsSwordItem.createAttributes(MUToolMaterials.JADE, 3, -2.3f)), "jade_tool.description", ChatFormatting.DARK_GREEN, ItemRegistry::getJadeToolEffectList, ItemRegistry::getEmptyList, ItemRegistry::getEmptyList));
    ...
    private static EffectList getEmptyList() {
        return EffectList.EMPTY;
    }

    private static List<Integer> getEmptyEffectsAplifiersList() {
        return List.of();
    }

    private static EffectList getAquamarineToolEffectList() {
        AquamarineData data = MUConfigHelper.getAquamarineValues();
        return new EffectList.Builder().addFullyVisibleEffect(FREEZE, (int) (data.tools_freeze_duration() * 20), 0).build();
    }
    ...
    private static EffectList getPeridotToolEffectList() {
        ...
        return new EffectList.Builder()
                .addFullyVisibleEffect(POISON, (int) (20 * data.tools_poison_duration()), data.tools_effects_amplifier())
                .addFullyVisibleEffect(CONFUSION, (int) (20 * data.tools_nausea_duration()), data.tools_effects_amplifier())
                .build();
    }
    ...
    private static EffectList getRubyToolEffectList() {
        ...
        return new EffectList.Builder()
                .addPartiallyVisibleEffect(DIG_SPEED, MobEffectInstance.INFINITE_DURATION, data.tools_haste_amplifier())
                .build();
    }
    ...
    private static EffectList getAmetrineToolEffectList() {
        ...
        return new EffectList.Builder()
                .addFullyVisibleEffect(LEVITATION, (int)(20 * data.tools_levitation_duration()),
    ...
    private static EffectList getJadeToolEffectList() {
        ...
        return new EffectList.Builder()
                .addPartiallyVisibleEffect(BOUNCER, MobEffectInstance.INFINITE_DURATION,
                        data.tools_bouncer_amplifier())
                .build();
    }
