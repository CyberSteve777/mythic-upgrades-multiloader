...
public class PacketHandler {
    ...
    public static void registerPackets() {
        ...
        Services.PLATFORM.registerClientPlayPacket(S2CConfigFilePayload.TYPE, S2CConfigFilePayload.STREAM_CODEC);
        Services.PLATFORM.registerClientPlayPacket(S2CSpelunkerDataPacket.TYPE, S2CSpelunkerDataPacket.STREAM_CODEC);
