...
public class ElytraItemForgeMixin {
    @WrapWithCondition(method = "elytraFlightTick", at = @At(value = "INVOKE", target = "Lnet/minecraft/world/item/ItemStack;hurtAndBreak(ILnet/minecraft/world/entity/LivingEntity;Ljava/util/function/Consumer;)V"))
